...
export const JUDGEMENT_RULES: JudgementRule[] = [
  ...
  },
  {
    ...
    sourceStatus: "SOURCE_DIRECT",
    sourceNote:
      "Iteration/quality semantics confirmed against the source's own worked example (Ramal-jyotish.pdf p.18): its prose explicitly states the chart stabilizes at iteration 4 (\"1st place's figure came to the 13th place, 2nd to 10th, 3rd to 11th, 4th to 14th\") with quality शुभ/Auspicious -- matching this engine's i===4 bucket exactly. The four hand-drawn intermediate charts themselves were deliberately NOT transcribed (glyph-reading risk, same issue as item 3); the textual confirmation was used instead of a cell-by-cell diagram match.",
    compute: (_chart, ctx) => {
